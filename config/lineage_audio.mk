...
ALARM_PATH := vendor/droid-ng/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/droid-ng/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/droid-ng/prebuilt/common/media/audio/ringtones
